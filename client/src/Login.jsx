        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden backdrop-blur-sm bg-opacity-95">
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-blue-600 px-8 py-10 text-center relative">
            ...
            <div className="relative w-20 h-20 bg-white rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-xl transform hover:scale-105 transition-transform">
              <ShoppingBag className="w-11 h-11 text-indigo-600" strokeWidth={2.5} />
            </div>

            {/* Title */}
            <h1 className="text-3xl font-bold text-white mb-2">Welcome Back!</h1>
            <p className="text-blue-100 text-sm">Login to continue shopping</p>
          </div>
          ...
          <div className="px-8 py-8">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-gray-200 rounded-xl hover:border-indigo-500 hover:bg-indigo-50 transition-all group">
            ...
            <div className="mt-6 bg-green-50 border border-green-100 rounded-xl p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <h4 className="text-sm font-semibold text-green-900 mb-0.5">Secure Login</h4>
